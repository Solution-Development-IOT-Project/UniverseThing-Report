...
| US026               | Perfil de usuario editable                                | Como usuario, quiero editar mis datos básicos (nombre, email, cooperativa), para mantener mi perfil actualizado.                                  | La app debe permitir editar y guardar cambios de perfil con validación de formato de email y datos obligatorios.    | EPIC005      
| US027               | Crear barra de navegación                                | Como usuario, quiero contar con una barra de navegacon para desplazarme en la página                                  |  Visualización del Topbar
Dado que que ingresó a la landing page Cuando está en la parte superior de la página    | EPIC005  
| US028               | Agregar información destacada                             | Como visitante, quiero entender qué hace la solución y sus beneficios principales para decidir si explorar más.
                                  | la landing debe contener: Misión, objetivo y beneficios en la landing    | EPIC005  
| US029               | Crear footer informativo                              | Como usuario, quiero poder contactar con la empresa de forma accesble, para poder contratar los servicios o obtener mas información.                   | La landing debe permitir visualizar información fundamental sobre la solución.  | EPIC005  
